      ...
      <div className="max-w-6xl mx-auto px-5 md:px-8 py-14 grid gap-10 md:grid-cols-4 relative">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3 mb-4">
            <span className="grid place-items-center w-11 h-11 rounded-full bg-sun text-ink font-display text-lg">
              S5
            </span>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-chalk/80">
            ...
            <li><Link to="/ppdb" className="hover:text-sun">PPDB</Link></li>
