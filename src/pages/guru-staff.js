...
// Kepala Sekolah memakai foto resmi; anggota lain memakai avatar inisial
// karena foto perorangan belum tersedia di aset sekolah.
const kepalaSekolah = {
...
const kelompok = [
  {
    ...
    anggota: [
      ...
      { nama: "Rahmaningrum, S.Pd.", peran: "Guru Kelas III B", nip: "198904262022212008" },
      { nama: "Siti Iptika, S.Pd.", peran: "Guru Kelas II A", nip: "199001012025212069" },
  ...
  },
  {
    ...
    warna: "daun",
    anggota: [
      { nama: "Nur Ubay, S.Pd.I", peran: "Guru PAI Kelas I–III & BTQ Kelas IV–VI", nip: "198706222025211015" },
      { nama: "Royan Fauzi, S.Pd.", peran: "Guru PAI Kelas IV–VI & BTQ Kelas I–III", nip: "198807082025211024" },
      { nama: "Aziz Priana, S.Pd.", peran: "Guru Mapel PJOK IV–VI AB", nip: "200007042025211018" },
      { nama: "Salsa Billa Syifa, S.Pd.", peran: "Guru Mapel PJOK I–III AB", nip: "200104032025212813" },
      { nama: "Amalia Muthia Khansa, S.Pd.", peran: "Guru Kelas V B & Mapel B. Inggris I–VI AB" },
      { nama: "Imasfufah, S.Pd.", peran: "GPK I–VI AB" },
      { nama: "Ridoh Anras, S.Kom.", peran: "Guru Bidang Informatika" },
    ],
  },
  {
  ...
  },
  {
    ...
    warna: "merah",
    anggota: [
      { nama: "Reynaldi Dwi Rafli", peran: "Pelatih Marawis" },
      { nama: "Nadia Arafah", peran: "Pelatih Pramuka PI" },
      { nama: "Rizky Nur Effendy", peran: "Pelatih Pramuka PA" },
      { nama: "Muhammad Okiyana Adegiantio", peran: "Pelatih Marching Band" },
      { nama: "Qatrun Nada Balqis Nabila Azzahra", peran: "Pelatih Marching Band" },
      { nama: "Fajrya Apriyanti, ST", peran: "Pelatih Taekwondo" },
      { nama: "Aqliyah Lutvy Triandi", peran: "Pelatih Tari" },
      { nama: "Andreas An Hadi", peran: "Pelatih Silat" },
    ],
  },
]
